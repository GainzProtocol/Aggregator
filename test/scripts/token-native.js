...
const tokenA = new Token(chainId, "0xC2C527C0CACF457746Bd31B2a698Fe89de2b6d49", 6, "USDT", "USDT"); //  TradeIn
...
async function executeTrade() {
    const tradeInAmount = "1000"; // Example: 1 TOKEN_A
    const amountIn = "1000000000"; // Example: 1 TOKEN_A
